<?php
/**
 * @version		$Id: stockablecustomfields.php 2015-04-24 18:59 sakis Terz $2
	...
	{    
		...
		if(!empty($custom_ids) && !empty($derived_product_ids)){			
			...
			if(!empty($stockable_customfields)){
				...
				//Adds a string as script at the end of your document 
				$script2="
				var currentProductid=$product->virtuemart_product_id;
				var vmrelease='".VM_RELEASE."';";
				
				if(version_compare(VM_RELEASE, '3.0.6.4','lt') && JFactory::getApplication()->input->get('tmpl')=='component'){
